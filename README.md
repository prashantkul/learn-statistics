...
| 2 | [Discrete random variables and their distributions](chapters/02-discrete-rvs/notes.md)<br/><sub>*"A random variable is a measurable function Ω → ℝ; its distribution is the pushforward."*</sub> | Ch 3–4 · Ch 2 | [open ↗](https://notebooklm.google.com/notebook/38bf32c7-1249-406a-9a9a-71423130adad) | [view](chapters/02-discrete-rvs/code/02_discrete_rvs.ipynb) |
